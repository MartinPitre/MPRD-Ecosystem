...
Author: Martin Pitre
Project: SUANR_V2
Canonical status: Frozen core reconstructed from the validated SUANR_V2 test
series supplied on 2026-09-21.

Evidence boundary
-----------------
This canonical implementation is the algorithm embedded in SUANR_V2
Validation Test 02 and is behaviorally identical to the supplied
``SUANR_V2_Core_Algorithm_v1_0.py``. Test 01 used frozen SUANR_V1 as a
feasibility control. Tests 03 and 04 used ensemble and split-conformal
validation machinery; those procedures are not silently merged into this
core because doing so would define a different algorithm.

Scientific boundary
-------------------
The percentile interval produced by this core describes the dispersion of
predictions generated by stochastic input perturbations. It must not be
called a calibrated prediction interval unless a separate calibration
procedure has verified its empirical coverage.
"""
